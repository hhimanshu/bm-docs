---
title: Claim
description: A Claim refers to a statement that refers to a fact in relation to a food product or a recipe. A claim can be derived based on multiple inputs such as ingredients, nutrients, allergens, and preparation method.
---
