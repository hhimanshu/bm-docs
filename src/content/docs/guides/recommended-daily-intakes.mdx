...
---
As we saw in the [Nutrients](/guides/nutrient) guide, nutrients are essential for the body to function properly. The amount of each nutrient that the body needs is called the **Recommended Daily Intake (RDI)** or **Recommended Daily Allowance (RDA)**.
