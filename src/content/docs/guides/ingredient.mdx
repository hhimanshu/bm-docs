...
- **Unit of Measurement**: The unit in which the quantity is measured. Some of the common units of measurement are grams (g), milliliters (ml), cups, tablespoons, teaspoons, etc. Read [Measurement Unit](/guides/measurement-unit) for more information.
