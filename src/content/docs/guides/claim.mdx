...
title: Claim
---
A **Claim** refers to a statement that refers to a fact in relation to a [food product](/guides/food) or a [recipe](/guides/recipe). A claim can be derived based on multiple inputs such as
- Ingredients
- Nutrients
- Allergens
- Preparation method
